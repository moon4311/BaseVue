    ...
    >
      ...
      <nav class="mt-10">
        ...
        <router-link
          ...
          to="/admin/code">
          <span class="mx-4">Code</span>
        </router-link>

        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'AuthName' ? activeClass : inactiveClass]"
          to="/admin/authName">
          <span class="mx-4">권한명</span>
        </router-link>
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'AuthRole' ? activeClass : inactiveClass]"
          to="/admin/authRole">
          <span class="mx-4">권한롤</span>
        </router-link>
        <router-link
          class="flex items-center px-6 py-2 mt-4 duration-200 border-l-4"
          :class="[$route.name === 'AuthGrant' ? activeClass : inactiveClass]"
          to="/admin/authGrant">
          <span class="mx-4">권한부여</span>
        </router-link>
